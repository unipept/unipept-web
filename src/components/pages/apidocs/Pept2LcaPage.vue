<template>
    <v-container>
        ...
        <p>
            This method returns the taxonomic lowest common ancestor for a given tryptic peptide. This is the same information as provided when performing a 
            search with the <RLink to="/tpa" router>Tryptic Peptide Analysis</RLink> in the web interface.
        </p>
        ...
        <HeaderBodyCard id="request" title="Request">
            ...
            <h3>input</h3>
            <p>
                <Code>input[]</Code> is a required parameter that takes one or more tryptic peptides. Unipept will return the taxonomic lowest common ancestor for 
                each of the <Code>input[]</Code> peptides based on their occurrence in UniProt entries. To pass multiple peptides at once, simply add 
            ...
            <p>
                ...
                defaults to <Code>false</Code>. When both <Code>names</Code> and <Code>extra</Code> are set to <Code>true</Code>, Unipept will return the names 
                of all ranks in the lineage of the taxonomic lowest common ancestor. Setting only <Code>names</Code> to <Code>true</Code> will not result in additional 
        ...
        <HeaderBodyCard id="response" title="Response" class="mt-5">
            <p class="mb-2">
                ...
                When the <Code>extra</Code> parameter is set to <Code>true</Code>, objects contain additional information about the lineage of the taxonomic lowest 
        ...
        >
            <template v-slot:description>
                This example retrieves the taxonomic lowest common ancestor for the tryptic peptide <i><Initialism>AIPQLEVARPADAYETAEAYR</Initialism></i>. The 
        ...
        >
            <template v-slot:description>
                This example retrieves the taxonomic lowest common ancestor for both the tryptic peptides <i><Initialism>AIPQLEVARPADAYETAEAYR</Initialism></i> and 
                <i><Initialism>APVLSDSSCK</Initialism></i>. The result is the same as the combination of this search and this search with the Tryptic Peptide 
        ...
        >
            <template v-slot:description>
                This example retrieves the taxonomic lowest common ancestor for the tryptic peptide <i><Initialism>APVLSDSSCK</Initialism></i>. In searching, 
                isoleucine (I) and leucinge (L) are considered equal. The result is the same as this search with the Tryptic Peptide Analysis in the web interface.
            </template>
            <template v-slot:post>
        ...
        >
            <template v-slot:description>
                This example retrieves the taxonomic lowest common ancestor for the tryptic peptide <i><Initialism>AIPQLEVARPADAYETAEAYR</Initialism></i> including 
                its complete lineage. The result is the same as this search with the Tryptic Peptide Analysis in the web interface.
            </template>
            <template v-slot:post>
        ...
        >
            <template v-slot:description>
                This example retrieves the taxonomic lowest common ancestor for the tryptic peptide <i><Initialism>AIPQLEVARPADAYETAEAYR</Initialism></i> including 
                its complete lineage with names. The result is the same as this search with the Tryptic Peptide Analysis in the web interface.
            </template>
            <template v-slot:post>
        ...
        <TryItCard id="try" class="mt-5" :response="tryItResponse" command="pept2lca">
            <template>
                <v-row>
