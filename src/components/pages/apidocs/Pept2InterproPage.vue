    ...
    <v-container>
        ...
        <HeaderBodyCard id="request" title="Request">
            ...
            <p>
                ...
                InterPro entries associated with each of the <Code>input[]</Code> peptides based on their occurrence in UniProt entries. To pass 
            ...
            <p>
                ...
                InterPro entry. See the <RLink to="#response" router>response</RLink> section for an overview of the information fields returned.
            </p>

            <h3>domains</h3>
            <p>
                <Code>domains</Code> is an optional parameter that can be used to separate the InterPro entries in groups according to their type 
            ...
            <StaticAlert title="Performance penalty">
                <p>
                    Setting <Code>extra</Code> to <Code>true</Code> has a performance penalty inferred from additional database queries. 
                ...
                <template v-slot:default>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-3">
                                Separates InterPro entries in groups according to their type <Code>true</Code>.
                                <br>
                                <div class="mt-3" style="font-size: 85%;">Value: Must be <Code>true</Code> or <Code>false</Code> (default)</div>
                            </td>
                        </tr>
