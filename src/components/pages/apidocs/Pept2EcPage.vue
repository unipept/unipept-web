<template>
    <v-container>
        <h1 class="font-weight-light">
            <Initialism>POST</Initialism> /api/v1/pept2ec
        </h1>
        ...
        <p>
            This method returns the functional <Initialism>EC</Initialism>-numbers associated with a given tryptic peptide. This is the same information as provided 
        ...
        <HeaderBodyCard id="request" title="Request">
            ...
            <StaticAlert title="Performance penalty">
                <p>
                    Setting <Code>extra</Code> to <Code>true</Code> has a performance penalty inferred from additional database queries. Do not use this parameter 
        ...
        >
            <template v-slot:description>
                This example retrieves all functional <Initialism>EC</Initialism>-numbers associated with the tryptic peptide 
        ...
        >
            <template v-slot:description>
                This example retrieves the functional <Initialism>EC</Initialism>-numbers for both the tryptic peptides <i><Initialism>AIPQLEVARPADAYETAEAYR</Initialism></i> 
        ...
        >
            <template v-slot:description>
                This example retrieves the functional <Initialism>EC</Initialism>-numbers associated with the tryptic peptide <i><Initialism>APVLSDSSCK</Initialism></i>. 
        ...
        >
            <template v-slot:description>
                This example retrieves the functional <Initialism>EC</Initialism>-numbers associated with the tryptic peptide 
                <i><Initialism>AIPQLEVARPADAYETAEAYR</Initialism></i> including the name of each <Initialism>EC</Initialism>-number. The result is the same as this search 
        ...
        <TryItCard id="try" class="mt-5" :response="tryItResponse" command="pept2ec">
            <template>
                <v-row>
...
const doRequest = async () => {
    tryItResponse.value = await unipeptCommunicator.pept2ec(input.value.split('\n'), equate_il.value, extra.value);
}

onBeforeMount(async () => {
    response1.value = await unipeptCommunicator.pept2ec(["AIPQLEVARPADAYETAEAYR"]);
    response2.value = await unipeptCommunicator.pept2ec(["AIPQLEVARPADAYETAEAYR", "APVLSDSSCK"]);
    response3.value = await unipeptCommunicator.pept2ec(["APVLSDSSCK"], true, undefined);
    response4.value = await unipeptCommunicator.pept2ec(["AIPQLEVARPADAYETAEAYR"], undefined, true);
})
</script>
