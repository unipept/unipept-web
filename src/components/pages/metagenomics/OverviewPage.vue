<template>
    <v-container>
        <StaticAlert class="mt-5" title="Getting started with UMGAP">
            <p>
        ...
        <HeaderBodyCard id="installation" title="Installation" class="mt-5">
            <p>
                ...
                and run <Code>rustc --version</Code>.
            </p>
            ...
            <StaticAlert class="mt-5" title="Installing Rust">
                <p>
                    If the <Code>rustc --version</Code> command returns <i>command not found</i>, Rust is not yet installed on your system. More 
            ...
            <p>
                ...
                <Code>git clone https://github.com/unipept/umgap.git</Code>. Alternatively, you can also click the download button on 
            ...
            <p>
                ...
                or downloaded the code, then run <Code>cargo install --path .</Code>. The output should look like this:
            </p>
            ...
            <p>
                <Initialism>UMGAP</Initialism> should now be installed to the <Code>~/.cargo/bin</Code> directory. To access it 
                everywhere, be sure to add it to your <Code>$PATH</Code>.
            </p>

            <p>
                After successful installation, the <Initialism>UMGAP</Initialism> command should be available. To check if it was 
                installed correctly, run <Code>umgap --version</Code>. This should print the version number:
            </p>
            ...
            <p>
                More information about the installed command can be found on these pages, or by running the <Code>umgap --help</Code> command.
            </p>
        </HeaderBodyCard>
        ...
        <HeaderBodyCard id="configuration" title="Configuration" class="mt-5">
            ...
            <p>
                Run the configuration script at <Code>scripts/umgap-setup.sh</Code> to interactively configure <Initialism>UMGAP</Initialism> 
